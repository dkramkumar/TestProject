...
public class ExtentManager {
   ...
   public static final String OUTPUT_FOLDER_SCREENSHOTS =System.getProperty("user.dir") + "/ScreenShot/";
   ...
   public static void createInstance() {
       ...
       ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter(REPORT_FILE_PATH+"Extent-Report.html");
       htmlReporter.config().setTheme(Theme.DARK);
       htmlReporter.config().setEncoding("utf-8");
       htmlReporter.config().setReportName("Automation Test Results");
       htmlReporter.config().setEncoding("utf-8");
       htmlReporter.config().setJS("$('.brand-logo').text('Demo QA');");
